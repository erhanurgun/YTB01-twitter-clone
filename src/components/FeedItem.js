    ...
    <article className="flex space-x-3 border-b border-gray-extraLight px-4 py-3 cursor-pointer">
      ...
      <div className="flex-1">
        <div className="flex items-center text-sm">
          <h4 className="font-black">{displayName}</h4>
          <span className="mx-2 text-gray-dark">{username}</span>
        ...
        <ul className="-ml-1 mt-3 flex justify-between max-w-md">
          ...
          <li className="group flex items-center space-x-3 text-gray-dark text-sm">
            ...
            <span className="group-hover:text-green-400">13</span>
          </li>
          <li className="group flex items-center space-x-3 text-gray-dark text-sm">
            ...
            <span className="group-hover:text-pink-400">17</span>
          </li>
          <li className="group flex items-center space-x-3 text-gray-dark text-sm">
            <div className="flex items-center justify-center w-8 h-8 rounded-full group-hover:bg-primary-light">
